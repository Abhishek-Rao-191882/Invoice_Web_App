    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_reference', models.CharField(blank=True, max_length=255, null=True)),
                ('sender_reference', models.CharField(blank=True, max_length=255, null=True)),
                ('invoice_tpye', models.CharField(choices=[('invoice', 'Invoice'), ('credit_note', 'Credit_note')], default='invoice', max_length=20)),
